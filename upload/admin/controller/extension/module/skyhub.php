...
include DIR_APPLICATION . 'controller/extension/module/skyhub/AddProduct.php';
...
class ControllerExtensionModuleSkyhub extends Controller
{
    ...
    public function install()
    {
        ...
        $this->model_setting_event->addEvent('product_update_skyhub', 'admin/model/catalog/product/addProduct/after', $this->route . '/addProduct');
    ...
    public function addProduct(&$route, &$args, &$output)  {
        ...
        if(!empty($output) && $skyhub_status) {
            $this->load->model($this->route);
            $product = $_->getProduct($output);
